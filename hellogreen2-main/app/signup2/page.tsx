    ...
    <>
       <div className="py-40">
        <div className="  flex flex-col items-center justify-center gap-5 ">
          ...
          <div className=" flex flex-col items-center justify-center">
            <p className=" text-md font-semibold">Enter Password again</p>
            <input type="password" className=" bg-white border-emerald-300 border rounded-md w-[400px] h-[40px] px-5 outline-none" />
          </div>

          <Link href="/" className="text-white font-bold bg-green-500 px-20 py-3 rounded-2xl"><p>Siign Up</p></Link>
        </div>
       </div>
